    ...
    return ThemeData(
      ...
      extensions: [
        CustomThemeExtension(
            ...
            bigButtonPauseColor: AppColours.greenAccent9,
            bigButtonStopColor: AppColours.magenta,
            popupBackgroundColor: AppColours.bgDark),
      ],
    );
  }
    ...
    return ThemeData(
      ...
      extensions: [
        CustomThemeExtension(
          ...
          popupBackgroundColor: const Color(0xFF723a11),
        ),
      ],
    );
  }
    ...
    return ThemeData(
      ...
      extensions: [
        CustomThemeExtension(
          ...
          popupBackgroundColor: const Color(0xFF247cbc),
        ),
      ],
    );
  }
    ...
    return ThemeData(
      ...
      extensions: [
        CustomThemeExtension(
          ...
          popupBackgroundColor: const Color(0xFF587504),
        ),
      ],
    );
  }
    ...
    return ThemeData(
      ...
      extensions: [
        CustomThemeExtension(
          ...
          popupBackgroundColor: const Color(0xFFC05656),
        ),
      ],
    );
  }
    ...
    return ThemeData(
      ...
      extensions: [
        CustomThemeExtension(
          ...
          bigButtonStopColor: const Color(0xFFAE2525),
          popupBackgroundColor: const Color(0xFFA50D0D),
        ),
      ],
    );
  }
